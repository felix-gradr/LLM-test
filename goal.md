...
- 1. Fix memory module, memory.jsonl is never saved to.
- 2. Clean up and refactor the repository. Reduce average file size for faster and easier writes.
- 3. Significatly improve the system prompt, create a system prompt directory that has a .txt file for each agent.
